...
- [x] 20-01-PLAN.md — FAQ页面实现 (HELP-03-01~04) ✅ (完成于 2026-05-21)
- [x] 18-02-PLAN.md — 接口文档增加Mermaid流程图 (HELP-01-02 增强) ✅ (完成于 2026-05-21)

**v2.1 Summary:**
- Phase 18: HELP-01-01~04 (接口文档)
- Phase 19: 商城用户登录与用户信息模块深度分析 (id/userId混淆问题修复方向)
