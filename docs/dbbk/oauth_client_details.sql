...
CREATE TABLE `oauth_client_details`  (
  ...
  `token_format` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'reference' COMMENT 'token格式: reference 引用令牌(不透明), self-contained 自包含令牌(jwt))',
...
INSERT INTO `oauth_client_details` VALUES (4, 'default', NULL, '$2a$10$YWKmKo8naV5gekYzrD5K7uXYF8.7fOCcCxDCp1XQJzRbLhm9YGlgS', 'portal-secret', 'app,openid,profile', 'password,refresh_token,client_credentials', 'http://127.0.0.1:8065', NULL, 3600, 28800, '{}', 'true', '2025-06-11 12:50:35', '2025-06-11 12:50:35', 'Portal门户前端', 'reference', 1);
