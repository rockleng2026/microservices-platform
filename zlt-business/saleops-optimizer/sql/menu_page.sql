...
) ENGINE = InnoDB AUTO_INCREMENT = 413 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单页面表' ROW_FORMAT = Dynamic;
...
INSERT INTO `menu_page` VALUES (18, '通用字典配置', 10, '/system/dict', '通用字典配置管理页面', NULL, 'setting', 8, 1, 0, '2025-06-10 11:08:19', 'default', NULL, NULL, NULL);
...
INSERT INTO `menu_page` VALUES (400, '盈策通决策平台', 0, '/saleops-optimizer', '盈策通决策平台主入口', NULL, 'bar-chart', 20, 1, 0, '2025-07-04 03:14:55', 'default', NULL, NULL, NULL);
INSERT INTO `menu_page` VALUES (401, '基础配置', 400, '/saleops-optimizer/config-center', '基础配置', NULL, 'setting', 1, 1, 0, '2025-07-04 03:14:55', 'default', NULL, NULL, NULL);
INSERT INTO `menu_page` VALUES (402, '月度绩效管理', 400, '/saleops-optimizer/monthly-performance', '月度绩效管理', NULL, 'performance', 2, 1, 0, '2025-07-06 23:40:47', 'default', NULL, NULL, NULL);
INSERT INTO `menu_page` VALUES (407, '薪酬管理', 400, '/saleops-optimizer/#', '薪酬计算', NULL, 'payroll', 3, 1, 0, '2025-07-07 16:43:24', 'default', NULL, NULL, NULL);
INSERT INTO `menu_page` VALUES (408, '薪酬计算', 407, '/saleops-optimizer/salary-calculation', '薪酬计算管理', NULL, 'calculator', 1, 1, 0, '2025-07-07 17:17:14', 'default', NULL, NULL, NULL);
INSERT INTO `menu_page` VALUES (409, '工资查询', 407, '/saleops-optimizer/salary-query', '工资查询统计', NULL, 'search', 2, 1, 0, '2025-07-07 17:17:14', 'default', NULL, NULL, NULL);
INSERT INTO `menu_page` VALUES (410, '工资条生成', 407, '/saleops-optimizer/payslip-generation', '工资条生成管理', NULL, 'file-text', 3, 1, 0, '2025-07-07 17:17:14', 'default', NULL, NULL, NULL);
INSERT INTO `menu_page` VALUES (411, '决策数据看板', 400, '/saleops-optimizer/dashboard', '盈策通决策数据看板', NULL, 'dashboard', 3, 1, 0, '2025-07-07 17:17:14', 'default', NULL, NULL, NULL);
INSERT INTO `menu_page` VALUES (412, '历史记录', 400, '/saleops-optimizer/history', '盈策通决策历史记录', NULL, 'history', 4, 1, 0, '2025-07-07 17:17:14', 'default', NULL, NULL, NULL);
