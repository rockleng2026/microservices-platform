...
VALUES 
('portal-web', NULL, '$2a$10$YWKmKo8naV5gekYzrD5K7uXYF8.7fOCcCxDCp1XQJzRbLhm9YGlgS', 'portal-secret', 'app,openid,profile', 'password,refresh_token,client_credentials', 'http://127.0.0.1:8000', NULL, 3600, 28800, '{}', 'true', NOW(), NOW(), 'Portal门户前端', 'reference', 1);
